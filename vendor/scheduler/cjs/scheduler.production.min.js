...
if ("undefined" !== typeof window && window._schedMock) {
  ...
  u = function(a, b) {
    -1 !== J
      ...
      : ((I = a),
        setTimeout(K, b, !0, b),
        setTimeout(K, 1073741823, !1, 1073741823));
  };
  t = function() {
    I = null;
  };
...
exports.unstable_InteractivePriority = 2;
exports.unstable_NormalPriority = 3;
exports.unstable_WheneverPriority = 4;
...
exports.unstable_scheduleCallback = function(a, b) {
  ...
  if (null === c) (c = a.next = a.previous = a), r(c);
  else {
    d = null;
    var f = c;
    do {
