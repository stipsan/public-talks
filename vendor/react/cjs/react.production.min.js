...
var k = require("object-assign"),
  ...
  z = n ? Symbol.for("react.placeholder") : 60113,
  A = n ? Symbol.for("react.pure") : 60115,
  B = "function" === typeof Symbol && Symbol.iterator;
function C(a, b, d, c, e, g, h, f) {
  if (!a) {
    a = void 0;
    if (void 0 === b)
      a = Error(
...
function N(a, b, d) {
  ...
  if (null != b)
    ...
    b))
      L.call(b, c) && !M.hasOwnProperty(c) && (e[c] = b[c]);
  ...
  return { $$typeof: p, type: a, key: g, ref: h, props: e, _owner: K.current };
}
function aa(a, b) {
  return {
    $$typeof: p,
...
function T(a, b, d, c) {
  ...
  if (Array.isArray(a))
    ...
    for (a = f.call(a), h = 0; !(e = a.next()).done; )
      (e = e.value), (f = b + U(e, h++)), (g += T(e, f, d, c));
  else
    "object" === e &&
      ((d = "" + a),
      D(
...
function W(a, b, d, c, e) {
  var g = "";
  null != d && (g = ("" + d).replace(P, "$&/") + "/");
  b = R(b, g, c, e);
  V(a, ca, b);
  S(b);
}
function da(a, b) {
  var d = K.currentDispatcher;
  null === d ? D("277") : void 0;
...
var X = {
  ...
  createContext: function(a, b) {
    ...
    a.Consumer = a;
    a.unstable_read = da.bind(null, a);
    return a;
  },
  ...
  pure: function(a, b) {
    return { $$typeof: A, render: a, compare: void 0 === b ? null : b };
  },
  Fragment: r,
  StrictMode: t,
